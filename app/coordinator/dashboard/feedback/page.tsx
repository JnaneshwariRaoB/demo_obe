...
export default function InnovativeTechniquesPage() {
  ...
  const [entries, setEntries] = useState<{ section: string; faculty: string; technique: string; topic: string; file: string; }[]>([]);
          ...
          <div className="bg-[#1D1529] p-6 rounded-xl border border-purple-700">
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                ...
                {entries.length === 0 && (
                  <tr>
                    <td colSpan={6} className="p-4 text-center text-gray-400">No entries yet.</td>
                  </tr>
                )}
              </tbody>
            </table>
