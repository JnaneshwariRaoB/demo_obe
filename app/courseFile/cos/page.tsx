...
export default function COSPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0D0B1F] via-[#1A132B] to-[#110A1C] p-10 text-white font-serif">
        ...
        <div className="space-y-6">
          {currentModules.map((module, idx) => (
            <div key={idx} className="bg-[#2B1F3A] p-6 rounded-xl border border-[#7E5AC8]">
              ...
              <input
                type="text"
                placeholder="e.g., Understand the basics of digital circuits"
